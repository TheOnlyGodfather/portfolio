  ...
  return (
    <div className="group relative flex cursor-pointer ">
      <motion.img
        ...
        src="/html5.png"
        alt="reactlogo"
        className="rounded-full border border-gray-500 object-fill w-24 h-24 md:w-28 md:h-28  xl:w-32 xl:h-32 filter group-hover:grayscale transition duration-300 ease-in-out"
      />
